...
<body>
    ...
    <div class="container">
        <div class="jumbotron" style = "color: #2c3e50; background-color: #ecf0f1;">
            <h1><i class="fas fa-motorcycle"></i> Bikes Gallery</h1>
            <p>A bunch of Reliable Rides For You.</p>
        </div>
        <div class="row">
            <?php 
                $query = "select * from vehicle_m where type = \"bike\"";
                $q = mysqli_query($conn, $query);
                if(mysqli_num_rows($q) > 0) {
                    while($result = mysqli_fetch_assoc($q)) {
                        if($result["model"] == "sports"){
                            $type = "sports";
                        }else if($result["model"] == "economy"){
                            $type = "economy";
                        }else {
                            $type = "classic";
                        }
                    ...
                    echo "<div class=\"col-lg-12\">
                        <h4 class = \"text-center\"> No Bikes Available </h4>
                    </div>";
                }
            ?>
