...
<body>
    ...
    <div class="container" style="max-width:500px; margin: 0 auto;">
        <h4 class="text-center">Rent A Vehicle</h4>
        <hr class="style-two">
        <?php
            $vehicle_id = $_GET["vehicle_id"];
            $url = "./renterform.php?value=".$vehicle_id;
        ?>
        <form name = "registration" method = "POST" action = <?php echo $url?>>
            <div class="form-group">
                <h4 style="color: white">Enter return date :-</h4>
                <input type="date" class="form-control" id="r_date" name = "r_date" placeholder="Enter Return Date" required>
            </div>
            <div class="form-group">
            <h4 style="color: white">Do you want a driver?</h4>
                <input type="checkbox" class="form-control" id="driver" name = "driver" value = "yes" required>
            </div>
            <div class="form-group">
                <h4 style="color: white">Select payment method :-</h4>
                    <select class="form-control" id="payment" name = "payment">
                        <option name = "cash" value = "cash" selected>cash</option>
    ...
    <!-- scripts to use -->
    <script src = "../assets/scripts/becomerenter.js"></script>
